...
<head>
	...
	<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/css/light/theme.css" id="themestyle">
	...
	<!-- Whitelabel Plugins -->
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/wl_Alert.js"></script>
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/wl_Dialog.js"></script>
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/wl_Form.js"></script>
...
<body id="login">
		...
		<section id="content">
		<form action="<?php echo Yii::app()->request->baseUrl; ?>/index.php/admin/login" method = "post">
			<fieldset>
