...
class Mailer extends CApplicationComponent
{
	 ...
	 */
	public $htmlFormat = false;
	
	public function init()
	{
	}
	
	public function send($to, $title, $body, $skip_disclaimer = false, $skip_bcc = false)
	{
		$body = $this->addDisclaimer($body, $skip_disclaimer);
		
		$headers = $this->prepareHeaders($skip_bcc);
	...
	protected function prepareHeaders($skip_bcc)
	{
		$headers = array();
