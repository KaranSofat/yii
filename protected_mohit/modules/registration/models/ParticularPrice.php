 ...
 * @property integer $particular_price
...
class ParticularPrice extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('service_id, customer_id, booking_id, bedroom, bathroom, property, desk, particular_price, date', 'required'),
			array('service_id, customer_id, booking_id, bedroom, bathroom, property, desk, particular_price', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, service_id, customer_id, booking_id, bedroom, bathroom, property, desk, particular_price, date', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'property' => 'Property',
			'desk' => 'Desk',
			'particular_price' => 'Particular Price',
			'date' => 'Date',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('particular_price',$this->particular_price);
