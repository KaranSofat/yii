...
class PriceAdmin extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('service_id, service_type_id, bedroom, bathroom, property, desk, cleaning_material_price, date', 'required'),
			array('service_id, service_type_id, bedroom, bathroom, property, desk, cleaning_material_price', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, service_id, service_type_id, bedroom, bathroom, property, desk, cleaning_material_price, date', 'safe', 'on'=>'search'),
		);
	}
