...
class PriceAdmin extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('service_id, service_type_id, bedroom, bathroom, property, desk, date', 'required'),
			array('service_id, service_type_id, bedroom, bathroom, property, desk, date', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, service_id, service_type_id, bedroom, bathroom, property, desk, date', 'safe', 'on'=>'search'),
		);
	}
