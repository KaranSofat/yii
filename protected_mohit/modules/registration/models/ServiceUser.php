 ...
 * @property AdditionalParticularPrice[] $additionalParticularPrices
 * @property AdditionalServicePrice[] $additionalServicePrices
 * @property Booking[] $bookings
 * @property CompanyRequest[] $companyRequests
 * @property DistanceCoverage[] $distanceCoverages
 * @property ParticularPrice[] $particularPrices
...
class ServiceUser extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('company_name, company_logo', 'required'),
			array('jobsdone, phone, status', 'numerical', 'integerOnly'=>true),
			array('lat, longitude', 'numerical'),
			array('email, city', 'length', 'max'=>45),
			...
			array('id, email, password, company_name, company_logo, city, zipcode, jobsdone, phone, lat, longitude, status, user_type, registered, lastlogin', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'additionalParticularPrices' => array(self::HAS_MANY, 'AdditionalParticularPrice', 'service_id'),
			...
			'companyRequests' => array(self::HAS_MANY, 'CompanyRequest', 'service_id'),
			'distanceCoverages' => array(self::HAS_MANY, 'DistanceCoverage', 'service_id'),
			'particularPrices' => array(self::HAS_MANY, 'ParticularPrice', 'service_id'),
			'priceAdmins' => array(self::HAS_MANY, 'PriceAdmin', 'service_id'),
			'providerAdditionalprices' => array(self::HAS_MANY, 'ProviderAdditionalprices', 'service_id'),
			...
			'servicestatusBycompanies' => array(self::HAS_MANY, 'ServicestatusBycompany', 'service_id'),
		);
	}
