...
class Registration extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('company_name,phone,city,zipcode,email,password', 'required'),
			array('phone, jobsdone', 'numerical', 'integerOnly'=>true),
			array('email','email'),
		    array('email', 'uniqueEmail'),
		    array('unipassword', 'matchPwd'),
		   
		     //array('cpassword', 'safe'),
			...
			array('id, email, password, company_name, company_logo, city, phone, zipcode, jobsdone, lat, longitude, registered, lastlogin', 'safe', 'on'=>'search'),
		);
	}
    ...
    public function matchPwd()
    {
    	...
    	if($_REQUEST['Registration']['password']!=$_REQUEST['Registration']['cpassword'])
    	{
    		 $this->addError('unipassword', 'Confirm Password Does not match !');
    	}	
    }
}
