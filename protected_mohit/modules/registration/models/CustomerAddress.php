...
class CustomerAddress extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('customer_id, address, zipcode, date', 'required'),
			array('customer_id', 'numerical', 'integerOnly'=>true),
			array('address, zipcode', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, customer_id, address, zipcode, date', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'bookings' => array(self::HAS_MANY, 'Booking', 'customer_address_id'),
