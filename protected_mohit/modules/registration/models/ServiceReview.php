...
class ServiceReview extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('service_id, customer_id, booking_id, rating, status', 'numerical', 'integerOnly'=>true),
			array('review, date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, service_id, customer_id, booking_id, review, rating, status, date', 'safe', 'on'=>'search'),
		);
	}
