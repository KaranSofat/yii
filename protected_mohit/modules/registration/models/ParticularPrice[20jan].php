...
class ParticularPrice extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('service_id, customer_id, booking_id, bedroom, bathroom, property, desk, date', 'required'),
			array('service_id, customer_id, booking_id, bedroom, bathroom, property, desk', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, service_id, customer_id, booking_id, bedroom, bathroom, property, desk, date', 'safe', 'on'=>'search'),
		);
	}
