...
class AdditionalParticularPrice extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('additional_service_id, service_id, customer_id, price, total_price, date', 'required'),
			array('additional_service_id, service_id, customer_id, price, total_price', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, additional_service_id, service_id, customer_id, price, total_price, date', 'safe', 'on'=>'search'),
		);
	}
