...
class CustomerUser extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('email, password, cname, clname, caddress, cregistered, clastlogin, type', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, email, password, cname, clname, caddress, cregistered, clastlogin, type', 'safe', 'on'=>'search'),
		);
	}
