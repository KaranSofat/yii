	...
	<body>
		...
		<section id="content">
              ...
              <?php $form=$this->beginWidget('CActiveForm', array(
			        'action'=> Yii::app()->createUrl('admin/faq/editfaq',array('id'=>$edit->id)),
					'id'=> $edit->id,
					...
					<fieldset>
						...
						<section><?php echo $form->labelEx($model,'question'); ?>
							<div>
							      <?php echo $form->textField($model,'question',array('value'=>$edit->question)); ?>
						...
						<section><?php echo $form->labelEx($model,'answer'); ?>
							<div>
                                  ...
                                  <?php echo $form->TextArea($model,'answer',array('class'=>"editor",'value'=>$edit->answer)); ?>
