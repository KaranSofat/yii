	...
	<body>
		...
		<div class="g6 widgets">
			...
			<div class="widget number-widget" id="widget_number">
				...
				<div>
					<ul>
						<li><a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/company/providerdetails"><span><?php echo count($name);?></span> Total Companies</a></li>
						<li><a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/customer/customerlisting"><span><?php echo count($customer);?></span> Total Customers</a></li>
