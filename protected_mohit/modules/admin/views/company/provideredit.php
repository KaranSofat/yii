              ...
              <?php $form=$this->beginWidget('CActiveForm', array(
					...
					<fieldset>
                        ...
                        <label>Other Details</label>
                            ...
                            <?php //if(!empty($additionalService)) { ?>
                            
                                    <?php 
                                             

                                              if(!empty($companyDetail->additionalServicePrices))
                                             {   

                                             foreach($companyDetail->additionalServicePrices as $ser)
                                             {
                                                 

                                      ?>
                                                
                                                <section><?php echo $form->labelEx($model,$ser->additionalService['service_name']); ?>
												<div>
												      <?php //echo $service->bedroom;?>
												      <?php echo $form->textField($model,$ser->additionalService['service_name'],array('value'=>$ser->price, 'class'=>'integer','name'=> 'PriceAditional['.$ser->additionalService['service_name'].']')); ?>
												     
						                              <?php echo $form->error($model,$ser->additionalService['service_name']); ?>
												</div>
									     </section>
                                    ...
                                    <?php }
                                             ...
                                             foreach($additionalService as $addSer) { 
                                         	?>  

	                                         <section><?php echo $form->labelEx($model,$addSer->service_name); ?>
													<div>
													      <?php //echo $service->bedroom;?>
													      <?php echo $form->textField($model,$addSer->service_name,array('value'=>'', 'class'=>'integer','name'=> 'PriceAditional['.$addSer->service_name.']')); ?>
													     
							                              <?php echo $form->error($model,$addSer->service_name); ?>
													</div>
										     </section>
