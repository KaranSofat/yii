		...
		<section id="content">
				...
				<form id="form" >
					<fieldset>
						...
						<section><label for="text_field">Additional Service Name</label>
							<div><?php echo $view->additional_service_name;?></div>
						</section>
						
						<section><label for="text_field">Additional Service Price</label>
							<div><?php echo $view->additional_service_price;?></div>
						</section>
