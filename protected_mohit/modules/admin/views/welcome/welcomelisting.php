...
?>
    ...
    $(document).ready(function(){
         ...
         $('.active').click(function(){
              ...
              var id=$(this).attr('id');
               ...
               $.ajax({
		    	                   type:'GET',  
					               url:"<?php echo Yii::app()->createUrl('admin/welcome/ajaxWelcomeStatus')?>",
        ...
        $('.deactive').click(function(){
              ...
              var id=$(this).attr('id');
               ...
               $.ajax({
		    	                   type:'GET',  
					               url:"<?php echo Yii::app()->createUrl('admin/welcome/ajaxWelcomeStatusDeactivate')?>",
	  ...
	  function dlt(id)
	  {
               ...
               if(confirm('Are you sure you want to delete this?'))
               {
                    $.ajax({
		    	                   type:'GET',  
					               url:"<?php echo Yii::app()->createUrl('admin/welcome/ajaxdeletewelcome')?>",
	...
	<body>
		...
		<section id="content">
			<div class="g12">
			<h1>Welcome Listing</h1>
			
			<a href ="<?php echo Yii::app()->request->baseUrl; ?>/admin/welcome/addwelcomecontent">
			<section style="float:right;margin-bottom:2px;"><div><button class="reset">Add Welcome Content</button></div></section>
			</a>
			<table class="datatable">
				...
				<tbody>
					...
					<tr class="gradeX">
						...
						<a href="<?php echo Yii::app()->createUrl('admin/welcome/welcomeedit')?>/<?php echo $l->id;?>" class="btn i_pencil" title="Edit"></a>
						<a href="<?php echo Yii::app()->createUrl('admin/welcome/welcomeview')?>/<?php echo $l->id;?>" class="btn i_folder" title="View"></a></td>
