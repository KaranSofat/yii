...
class ServiceUser extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('jobsdone', 'numerical', 'integerOnly'=>true),
			...
			array('id, email, password, company_name, company_logo, city, zipcode, jobsdone, lat, longitude, registered, lastlogin', 'safe', 'on'=>'search'),
		);
	}
