...
class PriceAdmin extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			//array('service_id,service_type_id,bedroom, bathroom, property, desk', 'required'),
			array('id, service_id, service_type_id, bedroom, bathroom, property, desk', 'numerical', 'integerOnly'=>true),
