...
class ConversationMsg extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('sender_id, sender_type, reciver_id, booking_id, reciver_type, subject, date', 'required'),
			array('sender_id, reciver_id, booking_id, sender_status, reciver_status', 'numerical', 'integerOnly'=>true),
			array('sender_type, reciver_type', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, sender_id, sender_type, reciver_id, booking_id, reciver_type, sender_status, reciver_status, subject, date', 'safe', 'on'=>'search'),
		);
	}
