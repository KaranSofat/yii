 ...
 */
class CustomerBooking extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('customer_id, service_id, service_type_id, price', 'numerical', 'integerOnly'=>true),
			array('trans_id', 'length', 'max'=>100),
			array('date', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, customer_id, service_id, service_type_id, price, trans_id, date', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return CustomerBooking the static model class
	 */
