...
class Booking extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('customer_id, service_id, service_type_id, customer_address_id', 'numerical', 'integerOnly'=>true),
			array('price', 'numerical'),
			array('trans_id', 'length', 'max'=>100),
			array('date', 'length', 'max'=>45),
			array('cleaningDetail, additional, additional_details', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, customer_id, service_id, service_type_id, customer_address_id, price, cleaningDetail, additional, trans_id, additional_details, date', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'additionalParticularPrices' => array(self::HAS_MANY, 'AdditionalParticularPrice', 'booking_id'),
			...
			'companyRequests' => array(self::HAS_MANY, 'CompanyRequest', 'booking_id'),
			'particularPrices' => array(self::HAS_MANY, 'ParticularPrice', 'booking_id'),
